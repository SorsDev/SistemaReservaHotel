        ...
        if(isset($_POST["ingresoUsuario"])){
            ...
            if(preg_match('/^[a-zA-Z0-9]+$/', $_POST["ingresoUsuario"]) &&
               preg_match('/^[a-zA-Z0-9]+$/', $_POST["ingresoPassword"])){
                ...
                $encryptarPassword = crypt($_POST["ingresoPassword"],
				...
				if($respuesta["usuario"] == $_POST["ingresoUsuario"] && $respuesta["password"] == $encryptarPassword){
                    ...
                    if($respuesta["estado"] == 1){
                        ...
                        echo "<div class='alert alert-danger mt-3 small'>El usuario esta desactivado</div>";
                   
                    }

                }else{

                    echo "<div class='alert alert-danger mt-3 small'>Usuario y/o contraseña incorrectos</div>";
                }
        ...
        if(isset($_POST["registroNombre"])){
            ...
            if(preg_match('/^[a-zA-ZñÑáéíóúÁÉÍÓÚ ]+$/', $_POST["registroNombre"]) &&
			   ...
			   preg_match('/^[a-zA-Z0-9]+$/', $_POST["registroPassword"])){
                ...
                $encryptarPassword = crypt($_POST["registroPassword"],
                '$2a$07$asxx54ahjppf45sd87a5a4dDDGsystemdev$');
		...
		if(isset($_POST["editarNombre"])){
			...
			if(preg_match('/^[a-zA-ZñÑáéíóúÁÉÍÓÚ ]+$/', $_POST["editarNombre"]) &&
			   preg_match('/^[a-zA-Z0-9]+$/', $_POST["editarUsuario"])){
				...
				$respuesta = ModeloAdministradores::mdlEditarAdministradores($tabla, $datos);
