...
class ControladorPlanes{
	...
	public function ctrRegistroPlan(){
		...
		if(isset($_POST["tipoPlan"])){
			...
			if(preg_match('/^[a-zA-Z0-9]+$/', $_POST["tipoPlan"]) && 
			   preg_match('/^[\/\=\\&\\;\\_\\*\\"\\<\\>\\?\\¿\\!\\¡\\:\\,\\.\\S\\|\\-\\0-9a-zA-ZñÑáéíóúÁÉÍÓÚ]+$/', $_POST["descripcionPlan"]) &&
	...
	public function ctrEditarPlan(){
		...
		if(isset($_POST["idPlan"])){
			...
			if(preg_match('/^[a-zA-Z0-9 ]+$/', $_POST["editarPlan"]) && 
			   preg_match('/^[\/\=\\&\\;\\_\\*\\"\\<\\>\\?\\¿\\!\\¡\\:\\,\\.\\S\\|\\-\\0-9a-zA-ZñÑáéíóúÁÉÍÓÚ]+$/', $_POST["editarDescripcionPlan"]) &&
