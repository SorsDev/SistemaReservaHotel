            ...
            <div class="col-12 col-lg-4 colIzqPerfil p-0 px-lg-3">
                ...
                <div class="descripcionPerfil">
                    ...
                    <figure class="text-center imgPerfil">
                        ...
                        <img src="<?php echo $servidor; ?>vistas/img/usuarios/default/default.png"
                                    ...
                                    <ul class="list-group">
                                                    ...
                                                    <form method="post">
                                                        ...
                                                        <div class="modal-body">
                                                            ...
                                                            <input type="hidden" name="idUsuarioPassword"
                                                                value="<?php echo $usuario["id_u"]; ?>">

                                                            <div class="form-group">

                                                                <input type="password" class="form-control"
                                                                    placeholder="Nueva contraseña" name="editarPassword"
                                                                    required>
                                        ...
                                        <li class="list-group-item small">
                                            <button class="btn btn-primary btn-lg" data-toggle="modal"
                                                data-target="#cambiarFotoPerfil">Cambiar Imagen</button>
                                        </li>
                    ...
                    <div class="col-12">
                        ...
                        <div class="card">
                            ...
                            <div class="card-body text-center">
                                ...
                                <h6> Fechas <?php echo $_COOKIE["fechaIngreso"]; ?> -
                                    <?php echo $_COOKIE["fechaSalida"]; ?></h6>
                            ...
                            <div class="card-footer d-flex bg-white">
                                ...
                                <form action="<?php echo $ruta.'perfil'; ?>" method="POST" class="pt-3">
                                    <script
                                        ...
                                        data-public-key="TEST-c56c0418-cd2a-4664-8a74-71b7a7119c94"
                        ...
                        <?php
							...
							if(isset($_REQUEST["token"])){
								...
								$issuer_id = $_REQUEST["issuer_id"];
							  	...
							  	MercadoPago\SDK::setAccessToken("TEST-4836725094360339-071101-f0ba3f4f56a0e03a57a21643db9a34f1-584599140");
            ...
            <div class="modal-body visorTestimonios">
                ...
                $(".verTestimonio").click(function() {
                    ...
                    if (testimonio != "") {
                        ...
                        $(".modal-body.visorTestimonios").html(
                            '<p>Aún no tiene testimonios de esta reserva</p>');
