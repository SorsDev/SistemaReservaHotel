...
Class ControladorReservas{
	...
	static public function ctrGuardarReserva($valor){
		...
		if($respuesta != ""){
			...
			$traerNotificaciones = ModeloReservas::mdlMostrarNotificaciones("notificaciones",
			"reservas");
		...
		if(isset($_POST["actualizarTestimonio"])){
			...
			if(preg_match('/^[?\\¿\\!\\¡\\:\\,\\.\\a-zA-Z0-9ñÑáéíóúÁÉÍÓÚ ]+$/', $_POST["actualizarTestimonio"])){
				...
				if($respuesta == "ok"){
					...
					$actualizarNotificaciones = ModeloReservas::mdlActualizarNotificaciones("notificaciones","testimonios", $cantidad);
